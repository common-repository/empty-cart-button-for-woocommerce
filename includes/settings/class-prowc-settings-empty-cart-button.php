...
if ( ! class_exists( 'ProWC_Settings_Empty_Cart_Button' ) ) :

class ProWC_Settings_Empty_Cart_Button extends WC_Settings_Page {
	...
	function __construct() {
		$this->id    = 'prowc_empty_cart_button';
	...
	function admin_notice_settings_reset() {
		echo '<div class="notice notice-warning is-dismissible"><p><strong>' .
			esc_html__( 'Your settings have been reset.', 'empty-cart-button-for-woocommerce' ) . '</strong></p></div>';
	}	
...
return new ProWC_Settings_Empty_Cart_Button();
